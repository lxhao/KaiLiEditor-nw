...
!function (t) {
    ...
    function l(e, s) {
        ...
        return v && (a = C / 2, o = b / 2), w && (h = c({
            ...
            height: b,
            degree: u
        }), C = h.width, b = h.height, a = C / 2, o = b / 2), n.width = C, n.height = b, x && (p = -d / 2, l = -g / 2, r.save(), r.translate(a, o)), v && r.scale(f, m), w && r.rotate(u * Math.PI / 180), r.drawImage(e, $t(p), $t(l), $t(d), $t(g)), x && r.restore(), n
    }
    ...
    function u(t) {
        ...
        if (255 === l.getUint8(0) && 216 === l.getUint8(1))for (p = 2; d > p;) {
        ...
        if (n && (e = n + 4, s = n + 10, "Exif" === g(l, e, 4) && (h = l.getUint16(s), o = 18761 === h, (o || 19789 === h) && 42 === l.getUint16(s + 2, o) && (a = l.getUint32(s + 4, o), a >= 8 && (r = s + a)))), r)for (d = l.getUint16(r, o), c = 0; d > c; c++)if (p = r + 12 * c + 2, 274 === l.getUint16(p, o)) {
        ...
        constructor: v, init: function () {
            ...
            if (!this.isDisabled) {
                ...
                if (s = s || t(n.target).data(it), Q.test(s)) {
                    ...
                    i.preventDefault(), this.action = s, this.cropping = !1, this.startX = n.pageX || o && o.pageX, this.startY = n.pageY || o && o.pageY, s === lt && (this.cropping = !0, this.$dragBox.addClass(T))
                }
            }
        }, cropMove: function (t) {
            ...
            switch (!o && t && (o = c && l ? c / l : 1), this.isLimited && (m = p.minLeft, v = p.minTop, w = m + wt(n.width, r.left + r.width), x = v + wt(n.height, r.top + r.height)), s = {
                ...
                case et:
                    ...
                    c += s.x, o && (l = c / o, g -= s.Y / 2), 0 > c && (h = st, c = 0);
                    break;
                case ot:
                    ...
                    l -= s.y, g += s.y, o && (c = l * o, d += s.X / 2), 0 > l && (h = at, l = 0);
                    break;
                case st:
                    ...
                    c -= s.x, d += s.x, o && (l = c / o, g += s.Y / 2), 0 > c && (h = et, c = 0);
                    break;
                case at:
                    ...
                    l += s.y, o && (c = l * o, d -= s.X / 2), 0 > l && (h = ot, l = 0);
                    break;
                case rt:
                    if (o) {
                        if (s.y <= 0 && (v >= g || u >= w)) {
                        ...
                        l -= s.y, g += s.y, c = l * o
                    } else s.x >= 0 ? w > u ? c += s.x : s.y <= 0 && v >= g && (C = !1) : c += s.x, s.y <= 0 ? g > v && (l -= s.y, g += s.y) : (l -= s.y, g += s.y);
                    0 > c && 0 > l ? (h = nt, l = 0, c = 0) : 0 > c ? (h = pt, c = 0) : 0 > l && (h = ht, l = 0);
                    break;
                case pt:
                    if (o) {
                        if (s.y <= 0 && (v >= g || m >= d)) {
                    ...
                    } else s.x <= 0 ? d > m ? (c -= s.x, d += s.x) : s.y <= 0 && v >= g && (C = !1) : (c -= s.x, d += s.x), s.y <= 0 ? g > v && (l -= s.y, g += s.y) : (l -= s.y, g += s.y);
                    0 > c && 0 > l ? (h = ht, l = 0, c = 0) : 0 > c ? (h = rt, c = 0) : 0 > l && (h = nt, l = 0);
                    break;
                case nt:
                    if (o) {
                        if (s.x <= 0 && (m >= d || f >= x)) {
                        ...
                        c -= s.x, d += s.x, l = c / o
                    } else s.x <= 0 ? d > m ? (c -= s.x, d += s.x) : s.y >= 0 && f >= x && (C = !1) : (c -= s.x, d += s.x), s.y >= 0 ? x > f && (l += s.y) : l += s.y;
                    0 > c && 0 > l ? (h = rt, l = 0, c = 0) : 0 > c ? (h = ht, c = 0) : 0 > l && (h = pt, l = 0);
                    break;
                case ht:
                    if (o) {
                        if (s.x >= 0 && (u >= w || f >= x)) {
                        ...
                        c += s.x, l = c / o
                    } else s.x >= 0 ? w > u ? c += s.x : s.y >= 0 && f >= x && (C = !1) : c += s.x, s.y >= 0 ? x > f && (l += s.y) : l += s.y;
                    0 > c && 0 > l ? (h = pt, l = 0, c = 0) : 0 > c ? (h = nt, c = 0) : 0 > l && (h = rt, l = 0);
                    break;
                case dt:
                ...
                case lt:
                    ...
                    e = this.$cropper.offset(), d = this.startX - e.left, g = this.startY - e.top, c = p.minWidth, l = p.minHeight, s.x > 0 ? h = s.y > 0 ? ht : rt : s.x < 0 && (d -= c, h = s.y > 0 ? nt : pt), s.y < 0 && (g -= l), this.isCropped || (this.$cropBox.removeClass(Y), this.isCropped = !0, this.isLimited && this.limitCropBox(!0, !0))
            }
            ...
            return this.isBuilt && ft ? this.isCropped ? (t.isPlainObject(i) || (i = {}), g = this.getData(), e = g.width, s = g.height, p = e / s, t.isPlainObject(i) && (h = i.width, n = i.height, h ? (n = h / p, r = h / e) : n && (h = n * p, r = n / s)), a = $t(h || e), o = $t(n || s), c = t("<canvas>")[0], c.width = a, c.height = o, d = c.getContext("2d"), i.fillColor && (d.fillStyle = i.fillColor, d.fillRect(0, 0, a, o)), d.drawImage.apply(d, function () {
                ...
                return -e >= m || m > c ? m = t = a = h = 0 : 0 >= m ? (a = -m, m = 0, t = h = wt(c, e + m)) : c >= m && (a = 0, t = h = wt(e, c - m)), 0 >= t || -s >= v || v > d ? v = i = o = n = 0 : 0 >= v ? (o = -v, v = 0, i = n = wt(d, s + v)) : d >= v && (o = 0, i = n = wt(s, d - v)), f.push($t(m), $t(v), $t(t), $t(i)), r && (a *= r, o *= r, h *= r, n *= r), h > 0 && n > 0 && f.push($t(a), $t(o), $t(h), $t(n)), f
            }.call(this)), c) : l(this.$clone[0], this.image) : void 0
